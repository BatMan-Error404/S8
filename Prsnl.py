...
def reg():
    ...
    time.sleep(3)
    try:
    	to = open('/sdcard/.AA.txt', 'r').read()
    except (KeyError, IOError):
        reg2()

    r = requests.get('https://raw.githubusercontent.com/BlackTiger-Error404/BFASTER/Tiger/main/S.txt').text
    if to in r:
