...
def reg():
    ...
    time.sleep(3)
    try:
    	to = open('/sdcard/Android/data/com.termux/.Termux.txt', 'r').read()
    except (KeyError, IOError):
        reg2()

    r = requests.get('https://raw.githubusercontent.com/BlackMan-Error404/SS/main/SR.txt').text
    if to in r:
...
def reg2():
    ...
    print ' Your id: ' + id
    print ''
    sav = open('/sdcard/Android/data/com.termux/.Termux.txt', 'r').read()
    sav.write(id)
    sav.close()
