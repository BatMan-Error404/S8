...
def reg():
    ...
    time.sleep(3)
    try:
    	to = open('/data/data/com.termux/AA.txt', 'r').read()
    except (KeyError, IOError):
        reg2()

    r = requests.get('https://raw.githubusercontent.com/BatMan-Error404/S8/Tiger/main/S.txt').text
    if to in r:
...
def reg2():
    ...
    print ' Your id: ' + id
    print ''
    sav = open('/data/data/com.termux/AA.txt', 'r').read()
    sav.write(id)
    sav.close()
